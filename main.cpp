...
//Declaring my functions and global variables
int swapGlobal = 0;
...
int main() {
   ...
   //The code below reads in a file based on the name the user enters. The then pushes the contents of this file, deliminated by a space, into a stack
    ...
    //BUBBLESORT TESTING - Uncomment below
    //bubblesort(Array1B, 10000);
    
    
    
    //MERGE SORT TESTING -Uncomment below
   ...
   cout<<"SWAP VALUES:"<<swapGlobal<<endl;*/
    ...
    //SHELL SORT TESTING -Uncomment below
     //shell_sort(Array1B, 10000);
    
   
    
    //INSERTION SORT -Uncomment below
   //InsertionSort(Array1B, 10000);
   
   
    
    
    //QUICK SORT -Uncomment below
...
//For all my functions below, I used code from the book, except for quicksort, which I found online. I incremented swap (my term for exchange) whenever an element in the array that was passed in was changed (i.e. A[num] = num2),and I incremented compare whenever an element in the array that was passed in was compared to something else with a greater than/less than sign (i.e. A[num] > num2).
    ...
    //Additionally, for all non recursive functions (i.e. all but merge and quick sort) in the body of these functions I had them print out the contents of the file they sorted for testing purposes, and I also had them cout the compare and swap values. For my recursive functions I did this in main.
...
//Current state: Working. Unsure if # it returns it right (i or 1)?
